...
class CountTransformer:
    ...
    # Method transforms set of k-mer count files to vector representations
    ...
    def doTransformation(self, speciesLevel):
        ...
        for file in os.listdir("Counts"):
            ...
            self.vectors.append(self.__getVectorRepresentation(file))
    ...
    def __getVectorRepresentation(self, kmerFile):
